...
import {
    ...
    MapPin, BookOpen, Users, Camera, Receipt, ChevronDown, GraduationCap
} from 'lucide-react';
    ...
    return (
        <div className="min-h-screen flex">
            ...
            <motion.div
                ...
                className="w-full lg:w-1/2 h-screen overflow-y-auto p-8 bg-gradient-to-br from-emerald-50 to-teal-50"
            >
                ...
                <div className="relative z-10 flex flex-col items-center justify-center w-full p-12">
                    ...
                    >
                        <div className="relative w-full max-w-md aspect-[3/4] group">
                            {/* Outer Glow */}
                            <div className="absolute -inset-4 bg-orange-500/20 rounded-[2.5rem] blur-2xl group-hover:bg-orange-500/30 transition-all duration-500"></div>
                            ...
                            <div className="absolute -bottom-8 -left-8 w-32 h-32 bg-orange-500/10 rounded-full blur-3xl animate-pulse delay-700"></div>
                        </div>
                    </motion.div>
