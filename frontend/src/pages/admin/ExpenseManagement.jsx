...
const categories = ['Office Rent', 'Salaries', 'Utilities', 'Marketing', 'Equipment', 'Internet', 'Maintenance', 'Transport', 'Course Income', 'Other'];
const emptyForm = { type: 'expense', title: '', amount: '', category: 'Office Rent', description: '', transactionDate: new Date().toISOString().slice(0, 10) };
...
const ExpenseManagement = () => {
    ...
    const openEdit = entry => {
        ...
        setForm({ type: entry.type, title: entry.title, amount: entry.amount, category: entry.category, description: entry.description || '', transactionDate: new Date(entry.transactionDate).toISOString().slice(0, 10) });
        setShowForm(true);
    };
