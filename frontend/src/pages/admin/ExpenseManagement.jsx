...
const emptyProject = () => ({ name: '', clientName: '', clientTotal: '', clientReceived: '', developers: [emptyDeveloper()], companies: [emptyCompany()], status: 'processing', startDate: today, completionDate: '', description: '' });
